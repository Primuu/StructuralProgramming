...
void cut_not_included1(char *text1, char *text2)
{
    int i, j;
...
void cut_not_included2(char *text1, char *text2)
{
    int i, j;
    int is_in_tab[256]={};
    for(i = 0; i < 256; i++)
...
void wcut_not_included(wchar_t *text1, wchar_t *text2)
{
    int i, j;
    for(i = 0, j = 0; *(text1 + i) != 0; i++)
        {
...
int main()
{
    ...
    wscanf(L"%s", wtext1);
    wscanf(L"%s", wtext2);
    wcut_not_included(wtext1, wtext2);
    wprintf(L"%s\n", wtext1);
